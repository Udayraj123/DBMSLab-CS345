...
MATCH (m:Mention)-[mt:MENTIONED_IN]->(t:Tweet{type:'Tweet'})-[th:HAS_HASHTAG]->(h:Hashtag{hashtag: 'TholiPremaPreRelease'})  
...
MATCH (a:Author)-[at:WROTE]->(t:Tweet{type:'Tweet'})-[th:HAS_HASHTAG]->(h:Hashtag{hashtag: 'HappyBirthdayJustinBieber'})  
return h.hashtag as Hashtag,a.author_screen_name as User,collect(t.tid) as tweet_ids, count( distinct t.tid) as tweetCount order by tweetCount Desc
